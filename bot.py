...
from config import LOGGER, PORT, OWNER_ID, SHORT_URL, SHORT_API, SHORT_TUT, VERIFY_COOLDOWN, VERIFY_REDIRECT_DELAY, VERIFY_LOG_CHANNEL, VERIFY_ACCESS_HOURS, SERVICE_URL
